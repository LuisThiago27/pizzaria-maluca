...
empresa.event = {
    ...
    init: () => {
        ...
        //evento quando sai com o mouse de cima da imagem
...
empresa.method = {
        ...
        app.method.get('/empresa/sobre', 
            (response) => {
                ...
                if(empresa.logotipo != null && empresa.logotipo != '') {
                    ...
                    document.getElementById("img-empresa").style.backgroundImage = `url('../public/images/default.png')`;
    ...
    uploadLogo: (logoUpload = []) => {
        ...
        if(logoUpload != undefined) {
            ...
            console.log(document.querySelector('#fileElem').files[0])
        }
    ...
    //DRAG AND DROP - remove a classe highlight quando sai com a imagem do container
    unhighlight: (e) => {
        DROP_AREA.classList.remove('highlight');
    },

    //DRAG AND DROP - quando solta a imagem do container
    handleDrop: (e) => {
